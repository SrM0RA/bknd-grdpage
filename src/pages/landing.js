...
export function Landing() {
    ...
    return(
        <div>
  <section className="mb-40 bg-[#390d28]">
    <Navbar/>
    <div className="text-center py-12 bg-[#390d28]">
        ...
        <h1 className="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12 bg-[#390d28]">JUST A SIMPLE GRADUATION<br /><span className="text-[#a69c31]">Not the one you dream of, but an option you can afford</span></h1>
    </div>
  </section>
  <section>
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 bg-[#cd3191]">
          ...
          <div className="mt-12 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8">
            {
              data ? (
                data.map((item) => (
                  <blockquote className="rounded-lg bg-[#8f2165]" key={item.ID}>
            ...
            {
        session ? (
          <div className="isolate bg-[#8f2165] py-24 px-6 sm:py-20 lg:px-8">
